Shader "Jettelly/liquido"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                fixed4 midEdge = step(i.liquidEdge, 0.5) - smoothstep(i.liquidEdge, 0.5, (0.5 - _MiddleAmount));
                fixed4 midEdgeColor = midEdge * _MiddleColor;
